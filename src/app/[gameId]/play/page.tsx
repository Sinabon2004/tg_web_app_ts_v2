    ...
    return(
        ...
        <div className={"h-[100dvh] w-full flex justify-center  bg-gray-800"}>
            ...
            <div className={"bg-gray-900 py-8 px-6 w-full max-w-[500px] flex flex-col gap-7"}>
                ...
                {/*        className={"group p-4 text-lg min-[350px]:text-2xl text-purple-100 font-semibold text-center" +*/}
                {/*    " bg-purple-600 rounded-lg hover:text-purple-600 hover:bg-purple-100" +*/}
                {/*    " transition flex justify-between gap-8 items-center  "}>*/}
                {/*    <h3>Вернуться назад</h3>*/}
                {/*    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5"*/}
                {/*         stroke="currentColor" className="stroke-purple-100 group-hover:stroke-purple-600  w-auto h-[20px] min-[350px]:h-[30px] transition ">*/}
                ...
                <div className={"w-full flex flex-col gap-4 flex-grow justify-end mb-3.5 "}>
                    <Link className={"group p-4 text-xl min-[350px]:text-2xl text-purple-100 font-semibold text-center" +
                        " bg-purple-600 rounded-lg hover:text-purple-600 hover:bg-purple-100" +
                        " transition flex justify-between gap-8 items-center  "} href={`/${id}/start`}>
                        <h3>Начать игру</h3>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5"
                             stroke="currentColor" className="stroke-purple-100 group-hover:stroke-purple-600  w-auto h-[30px] min-[350px]:h-[40px] transition ">
                            <path strokeLinecap="round" strokeLinejoin="round"
