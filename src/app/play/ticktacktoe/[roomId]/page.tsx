                                                                        ...
                                                                        <div key={x}
                                                                             ...
                                                                             }}>
                                                                            {
                                                                                el.user_id == null ?
                                                                                    ...
                                                                                    : (
                                                                                        el.user_id == user.id ?
                                                                                            <Image src="/ticktacktoe/O.svg" alt="CIRCLE" width={50} height={50} />
                                                                                            :
                                                                                            <Image src="/ticktacktoe/X.svg" alt="CROSS" width={50} height={50} />
                                                                                    )
                                                                            }
                                                                        </div>
                                                                    ))
                                                    ...
                                                    <div
                                                        ...
                                                        {(playData?.game_finished) ?
                                                            (playData?.winner_id == player1.id)   ?
                                                                ...
                                                                :
                                                                <div className="absolute inset-0">
                                                                    <Image width={100} height={100} src="/images/EmojiSad.svg" alt="LOSER"/>
                                                                </div>
                                                    ...
                                                    <div
                                                        ...
                                                        {(playData?.game_finished) ?
                                                            (playData?.winner_id == player2.id)   ?
                                                                ...
                                                                :
                                                                <div className="absolute inset-0">
                                                                    <Image src="/images/EmojiSad.svg" alt="LOSER" width={100}  height={100}/>
                                                                </div>
